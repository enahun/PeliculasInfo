...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { director: @info.director, genero: @info.genero, pelicula: @info.pelicula, usuario: @info.usuario }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { director: @info.director, genero: @info.genero, pelicula: @info.pelicula, usuario: @info.usuario }
    assert_redirected_to info_path(assigns(:info))
  end
